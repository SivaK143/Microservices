...
@Tag(name = "CRUD REST APIs for Loans Microservice", description = "CRUD REST APIs in EazyBank to CREATE, UPDATE, FETCH and DELETE loans")
@RestController
...
public class LoansController {
	...
	public ResponseEntity<ResponseDto> deleteLoanDeatils(
			@RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number must be 10 digits") String mobileNumber) {
	...
	@Operation(summary = "Get Java Vesrion", description = "Get Java versions details that is installed into accounts microservice")
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "HTTP Status OK"),
			@ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class))) })
